...
class NetgameModel
{
    ...
    public static function changeServer($op = 1, $ip = null, $netgameid = '127.0.0.1:5029', $title = 'SRB2 server', $version = '2.2.10', $roomname = null)
    { //Operation, Host, netgameID, servername, version, roomname.
    ...
    private static function db_execute(string $query)
    {
        ...
        // Sanity check
        if (self::$dsn == null) {
            echo "No DSN string given in config.\n";
            return false;
        }
        if (self::$username == null) {
            echo "No user name string given in config.\n";
            return false;
        }
        if (self::$password == null) {
            echo "No password string given in config.\n";
            return false;
        }
